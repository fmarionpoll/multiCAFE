...
import plugins.fmp.multicafe2.tools.nherve.toolbox.concurrent.MultipleDataTask;
import plugins.fmp.multicafe2.tools.nherve.toolbox.concurrent.TaskException;
...
import plugins.fmp.multicafe2.tools.nherve.toolbox.image.feature.descriptor.MultiThreadedSignatureExtractor.Listener;
...
public class MultiThreadedExecutionContext extends Algorithm
{
    ...
    public class SignatureExtractionWorker extends MultipleDataTask<IcySupportRegion, Integer>
    {
         ...
         * 
         * @see
         * plugins.fmp.multicafe2.tools.nherve.toolbox.concurrent.MultipleDataTask#call(java.
         * lang.Object, int)
         */
        @Override
         ...
         * 
         * @see
         * plugins.fmp.multicafe2.tools.nherve.toolbox.concurrent.MultipleDataTask#outputCall()
         */
        @Override
     ...
     *        The task manager
     * @param listeners
     *        The list of listeners called every time a new result is available.
     */
    public MultiThreadedExecutionContext(Segmentable image, IcySupportRegion[] regions,
            LocalDescriptor<Segmentable, ? extends Signature, IcyPixel> descriptor, TaskManager tm,
     ...
     *        The list of listeners called every time a new result is available.
     */
    public MultiThreadedExecutionContext(Segmentable image,
            LocalDescriptor<Segmentable, ? extends Signature, IcyPixel> descriptor, TaskManager tm,
            List<Listener> listeners)
    {
    ...
    public void start()
    {
        ...
        else
        {
            try
            {
                tm.submitMultiForAll(Arrays.asList(regions), SignatureExtractionWorker.class, this,
                        "Signatures extraction", 0);
            }
            catch (TaskException e)
            {
                e.printStackTrace();
