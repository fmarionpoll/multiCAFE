...
public class TaskManager extends Algorithm
{
     ...
     *        the show progress
     */
    public static void initAll(int mainPreferedSize, int secondLevelPreferedSize, boolean displayEnabled,
    ...
    public <Output> List<Output> submitAndWait(List<Callable<Output>> tasks, long slp)
     ...
     */
    public <Input, Output> List<Output> submitSingleForAll(List<Input> allDatas,
            Class<? extends SingleDataTask<Input, Output>> method, Object from, String msg, long slp)
            throws TaskException, InterruptedException
    {
        try
        {
     ...
     *         If the thread gets interrupted.
     */
    public <Input, Output> List<Output> submitMultiForAll(Input[] allDatas,
            Class<? extends MultipleDataTask<Input, Output>> method, Object from, String msg, long slp)
            throws TaskException, InterruptedException
    {
        return submitMultiForAll(Arrays.asList(allDatas), method, from, msg, slp);
    }

    public <Input, Output> List<Output> submitMultiForAll(List<Input> allDatas,
            Class<? extends MultipleDataTask<Input, Output>> method, Object from, String msg, long slp)
            throws TaskException, InterruptedException
    {
     ...
     *         If the thread gets interrupted.
     */
    public <Input, Output> List<Output> submitMultiForAll(List<Input> allDatas, Map<String, Object> contextualData,
            Class<? extends MultipleDataTask<Input, Output>> method, Object from, String msg, long slp)
            throws TaskException, InterruptedException
    {
        try
     ...
     *         the task exception
     */
    public <Key, Output> Map<Key, Output> waitResults(Map<Key, Future<Output>> poolResults, String msg, long slp)
            throws TaskException
    {
        try
        {
     ...
     *         If the thread gets interrupted.
     */
    public <Output> List<Output> waitResults(List<Future<Output>> poolResults, String msg, long slp)
            throws TaskException, InterruptedException
    {
        try
        {
     ...
     *         the task exception
     */
    public <Output> List<Output> waitResultLists(List<Future<List<Output>>> poolResults, String msg, long slp)
            throws TaskException
    {
        try
        {
