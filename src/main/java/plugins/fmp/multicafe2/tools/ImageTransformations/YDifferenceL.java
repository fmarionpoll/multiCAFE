...
public class YDifferenceL extends ImageTransformFunction implements TransformImage
{
	int spanx = 0;
	int deltax = 0;
	int spany = 4;
	...
	YDifferenceL(int spanx, int deltax, int spany,  int deltay, boolean computeL2)
	{
		this.spanx = spanx;
		this.deltax = deltax;
		this.spany = spany;
