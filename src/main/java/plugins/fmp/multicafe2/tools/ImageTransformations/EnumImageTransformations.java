...
public enum EnumImageTransformations {
	...
	SUBTRACT		("negative difference ", 	new NegativeDifference()),
	NORM_BRMINUSG	("(aR+bG+cB)/sum/255", 		new LinearCombinationNormed(-1, 2, -1)),
	...
	THRESHOLD_DIFF  ("threshold images difference",	new ThresholdDifference()),
