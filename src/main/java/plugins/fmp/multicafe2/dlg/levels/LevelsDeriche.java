...
public class LevelsDeriche extends JPanel implements PropertyChangeListener 
{
	...
	JComboBox<EnumTransformOp> transform1ComboBox = new JComboBox<EnumTransformOp> (new EnumTransformOp[] { EnumTransformOp.DERICHE});
