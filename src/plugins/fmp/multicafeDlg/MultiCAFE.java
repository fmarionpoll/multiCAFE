package plugins.fmp.multicafeDlg;
...
import plugins.fmp.multicafeDlg.cages.MCCages_;
import plugins.fmp.multicafeDlg.capillaries.MCCapillaries_;
import plugins.fmp.multicafeDlg.excel.MCExcel_;
import plugins.fmp.multicafeDlg.kymos.MCKymos_;
import plugins.fmp.multicafeDlg.levels.MCLevels_;
import plugins.fmp.multicafeDlg.sequence.MCSequence_;
...
public class MultiCAFE extends PluginActionable implements ViewerListener, PropertyChangeListener {
	public IcyFrame 		mainFrame 		= new IcyFrame("MultiCAFE 15-Sept-2020", true, true, true, true);
