...
import plugins.fmp.multicafe.MCCapillaries_;
import plugins.fmp.multicafe.MCExcel_;
import plugins.fmp.multicafe.MCKymos_;
import plugins.fmp.multicafe.MCLevels_;
import plugins.fmp.multicafe.MCMove_;
import plugins.fmp.multicafe.MCSequence_;
...
// SequenceListener?
public class MultiSpots extends PluginActionable implements ViewerListener, PropertyChangeListener {
	IcyFrame 		mainFrame 		= new IcyFrame("MultiSpots analysis 20-Jan-2020", true, true, true, true);
